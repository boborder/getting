...
import { setVeriClient, useVeriToken } from "~/.client/Trunstile";
import ClientTrunstile from "~/.client/Trunstile";
    ...
    <>
      ...
      >
        <label className="flex gap-2 items-center input join-item">
          ...
          <input name="username" type="text" placeholder="Username" defaultValue="bob" required className="input-ghost" />
        </label>
